...
def SommerfeldHuelten(XX, EE):
    ...
    if(EE==0):
        ...
        arg1 = (pi*pi)/fabs(XX*EE)
        arg2 = sqrt( 1.0 - ( 4.0/(pi*pi) )*XX*XX*EE ) 
        num = 2*XX*sinh( arg1 )
...
np.savetxt('Num_lists/NoSommTA.txt', ListTA)
...
np.savetxt('Num_lists/SommHueltenTA.txt', ListTA)
